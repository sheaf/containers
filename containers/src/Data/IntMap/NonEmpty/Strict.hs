...
--
--
-- = Non-empty Finite Int Maps (strict interface)
--
-- The @'IntMap' v@ type represents a non-empty finite map (sometimes called a dictionary)
...
-- Prelude functions:
--
-- > import Data.IntMap.NonEmpty.Strict (IntMap)
-- > import qualified Data.IntMap.NonEmpty.Strict as IntMap
--
...
-- the same as for the "Data.IntMap.NonEmpty.Lazy" module, so if they are used the
...
-- See the notes at the beginning of Data.IntMap.NonEmpty.Internal.
